...
public class BabyinfoActivity extends AppCompatActivity implements View.OnClickListener {
EditText n,wei,dob;
Button b;
...
startActivity (new Intent (BabyinfoActivity.this,BabyActivity.class));
