...
public class sectriActivity extends AppCompatActivity {
...
Button b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_sectri);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent interestIntent = new Intent(sectriActivity.this, PLActivity.class);
